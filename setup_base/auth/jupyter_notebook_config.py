...
#  Default: ''
# c.NotebookApp.certfile = '/auth/mycert.pem'
...
#  Default: ''
# c.NotebookApp.keyfile = '/auth/mykey.key'
...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$XmBNaZIOv51DMT0OJl6tpg$OHuI1OzwnleS+rMjt0Is9X+6j3om29Ba2SGoVMr/mP8'
...
#  Choices: any of ['blake2b', 'sha224', 'sha3_384', 'sha1', 'md5', 'sha384', 'sha3_512', 'sha3_256', 'sha256', 'sha512', 'blake2s', 'sha3_224']
#  Default: 'sha256'
